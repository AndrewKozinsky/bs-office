				...
				<li className='orders'>
					<div className='dropdown'>
						<span onClick={toggleExpanded}>
							Заказы
							<GoTriangleDown className={`icon ${expanded ? 'rotate' : ''}`} />
						</span>
