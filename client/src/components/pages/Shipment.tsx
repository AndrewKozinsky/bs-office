...
function Shipment() {
	...
	const acceptanceFetch = async (posishion, qrData, userRole, userName) => {
		console.log(
			`Fetching with posishion: ${posishion}, qrData: ${qrData}, userRole: ${userRole}, userName: ${userName}`,
		)
	...
	return (
		<div className='container-box'>
			<div className='container-block'>
				...
				{posishion === '' && <h1>Необходимо выбрать точку</h1>}
				...
				>
					<QRcodeScaner
						updateSearchWithQRCode={handleQRCodeScan}
