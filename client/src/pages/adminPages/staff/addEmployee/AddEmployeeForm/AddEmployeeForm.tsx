...
import { FieldType, FormNames, useGetAddEmployeeForm } from './fn/form.ts'
...
function AddEmployeeForm() {
	...
	const onChangeAddEmployeeForm = useGetAddEmployeeForm(form)
	const onFormSubmit = useGetOnAddEmployeeFormSubmit()

	return (
		<Form
			form={form}
			onChange={onChangeAddEmployeeForm}
