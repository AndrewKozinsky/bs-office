		...
		<>
			...
			<Routes>
				<Route
					path='/WarrantyRepair'
					element={
						userRole === 'Администратор' || userRole === 'Менеджер' || userRole === 'Мастер' ? (
							<WarrantyRepair />
						) : (
				...
				<Route
					path='/OrderStatus'
					element={
						userRole === 'Администратор' || userRole === 'Мастер' || userRole === 'Менеджер' ? (
							<OrderStatus />
						) : (
							<Navigate to='/PersonalAccount' />
						)
				...
				<Route
					path='/Employees'
					element={userRole === 'Администратор' ? <Employees /> : <Navigate to='/PersonalAccount' />}
				/>
				<Route
					path='/ChangeOrder'
					element={
						userRole === 'Администратор' || userRole === 'Мастер' ? (
							<ChangeOrder />
						) : (
							<Navigate to='/PersonalAccount' />
						)
				...
				<Route
					path='/SearchOrder'
					element={
						userRole === 'Администратор' || userRole === 'ADMIN' || userRole === 'Менеджер' ? (
							<SearchOrder />
						) : (
							<Navigate to='/PersonalAccount' />
						)
				...
				<Route
					path='/adminka'
					element={userRole === 'Администратор' ? <Adminka /> : <Navigate to='/PersonalAccount' />}
				/>
				<Route
					path='/Acceptance'
					element={
						userRole === 'Туркистанская' ||
						userRole === 'Выдача' ||
						userRole === 'Отправка' ||
